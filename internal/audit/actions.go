...
var actions = map[string]meta{
	...
	// internal/plugins/rapsheet. A ban and a kick are the two things here
	// with no undo on Discord's side, so they read as errors; everything
	// that adds to a member's record is a warning; what settles or corrects
	// the record is success; configuration is information.
	"rapsheet.ban":                  {title: "Rapsheet: member banned", color: core.ColorError},
	"rapsheet.kick":                 {title: "Rapsheet: member kicked", color: core.ColorError},
	"rapsheet.timeout":              {title: "Rapsheet: member timed out", color: core.ColorWarning},
	"rapsheet.warn":                 {title: "Rapsheet: member warned", color: core.ColorWarning},
	"rapsheet.escalated":            {title: "Rapsheet: ladder consequence applied", color: core.ColorWarning},
	"rapsheet.note":                 {title: "Rapsheet: note added", color: core.ColorInfo},
	"rapsheet.unban":                {title: "Rapsheet: ban lifted", color: core.ColorSuccess},
	"rapsheet.void":                 {title: "Rapsheet: entry voided", color: core.ColorSuccess},
	"rapsheet.edit":                 {title: "Rapsheet: entry reason edited", color: core.ColorInfo},
	"rapsheet.suggestion_dismissed": {title: "Rapsheet: ladder suggestion dismissed", color: core.ColorInfo},
	"rapsheet.linked":               {title: "Rapsheet: accounts linked", color: core.ColorWarning},
	"rapsheet.unlinked":             {title: "Rapsheet: account unlinked", color: core.ColorInfo},
	"rapsheet.configured":           {title: "Rapsheet: configuration changed", color: core.ColorInfo},
	"roles.script_enabled":          {title: "Script turned on", color: core.ColorWarning},
	"roles.script_disabled":         {title: "Script turned off", color: core.ColorWarning},
	"roles.eternal_added":           {title: "Eternal role added", color: core.ColorWarning},
	"roles.eternal_removed":         {title: "Eternal role removed", color: core.ColorInfo},
	"roles.eternal_reassigned":      {title: "Eternal role: given back", color: core.ColorWarning},
	"roles.eternal_recreated":       {title: "Eternal role: recreated", color: core.ColorWarning},
...
func buildEmbed(actorID, action, oldValue, newValue string) *discordgo.MessageEmbed {
	...
	if items, ok := parseDetail(newValue); ok && oldValue == "" {
		embed.Description, embed.Fields = gridLayout(embed.Fields, items)
		return embed
	}
